...
#     mp4_1080 = models.FileField(upload_to=get_upload_file_name, blank=True, null=True)
#     file_path_mp4_480 = models.FileField(upload_to=get_upload_file_name, blank=True, null=True)
#     file_path_mp4_720 = models.FileField(upload_to=get_upload_file_name, blank=True, null=True)
#     file_path_mp4_1080 = models.FileField(upload_to=get_upload_file_name, blank=True, null=True)
